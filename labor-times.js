...
export const LABOR_TIMES = {
  ...
  rr_body: {
    ...
    radiator:                 { hours: [1.5, 2.5], type: "mechanical", notes: "Drain, disconnect, R&R" },
    radiator_assembly:        { hours: [1.5, 2.5], type: "mechanical" },
    ac_condenser:             { hours: [2.0, 3.5], type: "mechanical", notes: "Requires A/C evacuate before R&R" },
    ac_compressor:            { hours: [2.5, 4.0], type: "mechanical" },
    ...
    cooling_fan_assembly:     { hours: [0.8, 1.5], type: "mechanical" },
    cooling_fan:              { hours: [0.8, 1.5], type: "mechanical" },
    water_pump:               { hours: [2.5, 4.0], type: "mechanical" },
    thermostat:               { hours: [0.5, 1.5], type: "mechanical" },
    alternator:               { hours: [1.0, 2.0], type: "mechanical" },
    starter:                  { hours: [1.5, 2.5], type: "mechanical" },
    ...
    power_steering_rack:      { hours: [3.0, 5.0], type: "mechanical" },
    ...
    tie_rod_end:              { hours: [0.8, 1.2], type: "mechanical" },
    stabilizer_bar_link:      { hours: [0.3, 0.8], type: "mechanical" },
    wheel_hub_bearing:        { hours: [1.5, 2.5], type: "mechanical" },
    cv_axle:                  { hours: [1.5, 2.5], type: "mechanical" },
