...
export const AUTO_PARTS_PRICING = {
  ...
  radiator_support: {
    economy:     { repair: [200, 500],   replace: [150, 400],    labor_hours: [3, 5] },
    midsize:     { repair: [300, 700],   replace: [200, 600],    labor_hours: [3, 5] },
    premium:     { repair: [400, 900],   replace: [350, 900],    labor_hours: [3, 6] },
    luxury:      { repair: [500, 1200],  replace: [500, 1400],   labor_hours: [4, 7] },
    ultra_luxury:{ repair: [800, 2000],  replace: [1000, 3000],  labor_hours: [5, 8] },
    truck_suv:   { repair: [400, 900],   replace: [300, 800],    labor_hours: [3, 6] },
  },
  bumper_reinforcement: {
    economy:     { repair: [null, null], replace: [80, 200],     labor_hours: [0.5, 1] },
    midsize:     { repair: [null, null], replace: [100, 300],    labor_hours: [0.5, 1] },
    premium:     { repair: [null, null], replace: [150, 500],    labor_hours: [0.5, 1.5] },
    luxury:      { repair: [null, null], replace: [200, 700],    labor_hours: [0.5, 1.5] },
    ultra_luxury:{ repair: [null, null], replace: [400, 1200],   labor_hours: [1, 2] },
    truck_suv:   { repair: [null, null], replace: [120, 400],    labor_hours: [0.5, 1] },
  },
  ac_condenser: {
    economy:     { repair: [null, null], replace: [150, 350],    labor_hours: [1, 2] },
    midsize:     { repair: [null, null], replace: [200, 500],    labor_hours: [1, 2.5] },
    premium:     { repair: [null, null], replace: [300, 700],    labor_hours: [1.5, 3] },
    luxury:      { repair: [null, null], replace: [400, 1000],   labor_hours: [2, 3.5] },
    ultra_luxury:{ repair: [null, null], replace: [600, 1500],   labor_hours: [2, 4] },
    truck_suv:   { repair: [null, null], replace: [250, 600],    labor_hours: [1, 2.5] },
  },
  radiator: {
    economy:     { repair: [null, null], replace: [150, 400],    labor_hours: [1, 2] },
    midsize:     { repair: [null, null], replace: [200, 600],    labor_hours: [1.5, 3] },
    premium:     { repair: [null, null], replace: [300, 800],    labor_hours: [2, 3.5] },
    luxury:      { repair: [null, null], replace: [400, 1200],   labor_hours: [2, 4] },
    ultra_luxury:{ repair: [null, null], replace: [600, 2000],   labor_hours: [2.5, 5] },
    truck_suv:   { repair: [null, null], replace: [250, 700],    labor_hours: [1.5, 3] },
  },
  fog_lamp: {
    economy:     { repair: [null, null], replace: [40, 120],     labor_hours: [0.3, 0.5] },
    midsize:     { repair: [null, null], replace: [60, 200],     labor_hours: [0.3, 0.6] },
    premium:     { repair: [null, null], replace: [100, 350],    labor_hours: [0.3, 0.8] },
    luxury:      { repair: [null, null], replace: [150, 500],    labor_hours: [0.5, 1] },
    ultra_luxury:{ repair: [null, null], replace: [300, 800],    labor_hours: [0.5, 1] },
    truck_suv:   { repair: [null, null], replace: [80, 250],     labor_hours: [0.3, 0.6] },
  },
  frame: {
...
const AUTO_COMPONENT_ALIASES = {
  ...
  "chassis": "frame",
  "radiator support": "radiator_support", "core support": "radiator_support", "radiator core support": "radiator_support",
  "radiator support assembly": "radiator_support", "core support assembly": "radiator_support",
  "ac condenser": "ac_condenser", "a/c condenser": "ac_condenser", "condenser": "ac_condenser",
  "ac condenser assembly": "ac_condenser", "air conditioning condenser": "ac_condenser",
  "radiator": "radiator", "radiator assembly": "radiator", "cooling radiator": "radiator",
  "fog lamp": "fog_lamp", "fog light": "fog_lamp", "fog lamp assembly": "fog_lamp", "fog light assembly": "fog_lamp",
  "front bumper reinforcement": "bumper_reinforcement", "rear bumper reinforcement": "bumper_reinforcement",
  "bumper reinforcement": "bumper_reinforcement", "bumper reinforcement bar": "bumper_reinforcement",
  "bumper impact bar": "bumper_reinforcement", "rebar": "bumper_reinforcement",
...
Use the exact component keys: ${relevant.join(", ")}.`;
    ...
    // Skip Gemini grounding call — Perplexity handles price lookups now
    return null;
